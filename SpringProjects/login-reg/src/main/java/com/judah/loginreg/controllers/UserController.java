package com.judah.loginreg.controllers;
...
import com.judah.loginreg.models.LoginUser;
import com.judah.loginreg.models.User;
import com.judah.loginreg.services.UserService;
...
public class UserController {
	...
	public String registerUser(
		...
		if(!user.getPassword().equals(user.getConfirm())) {
			result.rejectValue("passwords", "Match", "passwords not matching");
		}
